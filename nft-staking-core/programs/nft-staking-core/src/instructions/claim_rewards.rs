...
use mpl_core::{
    ID as MPL_CORE_ID, accounts::{BaseAssetV1, BaseCollectionV1}, fetch_plugin, instructions::UpdatePluginV1CpiBuilder, types::{Attribute, Attributes, Plugin, PluginType, UpdateAuthority}
};
          ...
          match attribute.key.as_str() {
              "staked" => {
                  ...
                  attribute_list.push(Attribute { 
                      ...
                      value: "true".to_string() //keeps the NFT staked
                  });
              }
              "staked_at" => {
                  ...
                  attribute_list.push(Attribute { 
                      ...
                      value: current_timestamp.to_string() //updates the staked at timestamp
                  });
              }
              _ => {
